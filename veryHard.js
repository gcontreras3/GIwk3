...
let tom = new Person ("Tom", "Front-End Dev", 25)
// console.log(tom)
console.log(tom.exercise())
class Programmer extends Person {
    constructor(name, job, age, languages = []) {
        super(name, job, age) // inherits
    ...
    offerNewTask() {
        if(this.busy){
            console.log("Cant accept new tasks")
        }else {
            console.log("take on new tasks")
        }
    }
    ...
    listLanguages() {
        this.languages.forEach(languages => console.log(languages))
    }
}
let bob = new Programmer ("Bob", "WebDev", 45, ["Python", "JAVA", "CSS"])
// console.log(bob.completeTask())
console.log(bob.busy)
bob.learnLanguages("JS")
console.log(bob.listLanguages())